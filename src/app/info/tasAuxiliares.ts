...
export const DIRECCIONES = [
    [1, 'DNSISa', 'Dirección Nacional de Sistemas de Información Sanitaria'],
    [2, 'DIIS', 'Dirección de Integración de la Información Sanitaria'],
    [3, 'DIEYD', 'Dirección de Interoperabilidad, Estándares y Desarrollo']
]

export const DIRECCION_FUNCIONES = [
    'Director Nacional', 'Director de línea', 'Responsable de area', 
    'Analista funcional', 'Control de calidad', 
    'Contenidos', 'Diseño multimedial', 
    'Evaluación y monitoreo', 
    'Programador FrontEnd', 'Programador BackEnd', 'DBA', 'Dev Ops',
    'activista floral', 'bibliotecario'
]
...
export const EQUIPO = [
    ...
    1,
    [2],
    'Desarrolladora java / Desarrollador PL / Referente técnico / ahhhh bueno',
    'https://i.pinimg.com/originals/eb/01/a8/eb01a8e5b2fcc1b6ddea4a8ae4dd5b64.jpg',
    true
    ], [
    16,
    ...
    1,
    [2],
    'Desarrolladora PL / reina del SMIS',
    'https://i.pinimg.com/originals/eb/01/a8/eb01a8e5b2fcc1b6ddea4a8ae4dd5b64.jpg',
    true
    ], [
    18,
    ...
    [2],
    'QA',
    'assets/img/png/equipo/soporte/debora.png',
    true
    ], [
    19,
    'Natalia Solange',
    ...
    1,
    [2],
    'Secretaria del SISA / Ama de la burocracia / modelo de tobillos',
    'https://i.pinimg.com/originals/eb/01/a8/eb01a8e5b2fcc1b6ddea4a8ae4dd5b64.jpg',
    true
    ], [
    20,
